...
import 'package:tdd_trivia/core/platform/network_info.dart';
...
class NumberTriviaRepoImpl implements NumberTriviaRepository {
  ...
  Future<Either<Failure, NumberTrivia>> _getTrivia(
    Future<NumberTriviaModel> Function() getRandomOrConcreteTrivia,
  ) async {
    if (await networkInfo.isConnected) {
      try {
        final remoteTrivia = await getRandomOrConcreteTrivia();
